...
* Это работает, потому что поисковики обычно проверяют на вирусы сайты, которые они ставят на топовые места в выдаче
...
* Если сайт в выдаче ниже 5-го места - тут уже надо задуматься, ссылка может быть опасна
