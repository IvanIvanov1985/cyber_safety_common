...
### Проверить файл или ссылку на вирусы сразу всеми антивирусами
...
* **Важно** - поменять пароль шифрования нельзя. Только через очистку диска и потом запись на него всего заново с новым паролем шифрования

## Теория про сложности паролей
* Тут бы дописть деталей тоже в сжатом ввиде, но пока не успеваю, так вот хорошая ссылка, где тоже коротко написано как придумать хороший пароль https://support.kaspersky.ru/common/windows/3730
